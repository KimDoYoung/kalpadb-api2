/**
 * 공지사항(gongji) 페이지 Initialization
 * src/main/resources/templates/user1/board/gongji.html용 JavaScript
 *
...
/**
 * 공지사항 페이지 Alpine Data
 */
export function initGongjiPage() {
    return {
        ...initAlpineBase(),
        ...
        onSearch(e) {
            ...
            window.location.href = `/user1/board/gongji?${params.toString()}`;
        },
         ...
         */
        viewPost(postId) {
            window.location.href = `/user1/board/gongji/${postId}`;
        },
