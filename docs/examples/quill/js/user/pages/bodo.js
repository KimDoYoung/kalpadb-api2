/**
 * 보도자료(bodo) 페이지 Initialization
 * src/main/resources/templates/user1/board/bodo.html용 JavaScript
 *
...
/**
 * 보도자료 페이지 Alpine Data
 */
export function initBodoPage() {
    return {
        ...initAlpineBase(),
        ...
        onSearch(e) {
            ...
            window.location.href = `/user1/board/bodo?${params.toString()}`;
        },
         ...
         */
        viewPost(postId) {
            window.location.href = `/user1/board/bodo/${postId}`;
        },
