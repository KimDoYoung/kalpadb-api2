/**
 * Chatbot Page Initialization
 * src/main/resources/templates/user1/product/chatbot.html용 JavaScript
 */
...
/**
 * Chatbot Page Alpine Data
 */
export function initChatbotPage() {
    return {
        ...initAlpineBase(),

        // Product submenu state (chatbot.html의 nav에서 사용)
        submenuOpen: false,
